...
import com.shubham.weather.db.DatabaseHelper;

import java.io.IOException;
import java.util.HashMap;
import java.util.Map;

public class DayWiseAdapter {
    ...
    public DayWiseAdapter(Context context)
    {
    ...
    public DayWiseAdapter createDatabase() throws SQLException
    {
        try
        {
    ...
    public DayWiseAdapter open() throws SQLException
    {
        try
        {
