...
import static com.shubham.weather.util.WeatherConstants.CITY_NAME;
import static com.shubham.weather.util.WeatherConstants.CLOUDINESS;
import static com.shubham.weather.util.WeatherConstants.CLOUDINESS_UNIT;
import static com.shubham.weather.util.WeatherConstants.CLOUDS;
import static com.shubham.weather.util.WeatherConstants.COORD;
import static com.shubham.weather.util.WeatherConstants.COORD_LAT;
import static com.shubham.weather.util.WeatherConstants.COORD_LON;
import static com.shubham.weather.util.WeatherConstants.DESCRIPTION;
import static com.shubham.weather.util.WeatherConstants.HUMIDITY;
import static com.shubham.weather.util.WeatherConstants.HUMIDITY_UNIT;
import static com.shubham.weather.util.WeatherConstants.ICON_ID;
import static com.shubham.weather.util.WeatherConstants.MAIN;
import static com.shubham.weather.util.WeatherConstants.PRESSURE;
import static com.shubham.weather.util.WeatherConstants.PRESSURE_UNIT;
import static com.shubham.weather.util.WeatherConstants.TEMP;
import static com.shubham.weather.util.WeatherConstants.TEMP_MAX;
import static com.shubham.weather.util.WeatherConstants.TEMP_MIN;
import static com.shubham.weather.util.WeatherConstants.TEMP_UNIT;
import static com.shubham.weather.util.WeatherConstants.WEATHER;
import static com.shubham.weather.util.WeatherConstants.WIND;
import static com.shubham.weather.util.WeatherConstants.WIND_DEGREES;
import static com.shubham.weather.util.WeatherConstants.WIND_DEGREES_UNIT;
import static com.shubham.weather.util.WeatherConstants.WIND_SPEED;
import static com.shubham.weather.util.WeatherConstants.WIND_SPEED_UNIT;
...
public class MainActivity extends AppCompatActivity {
    ...
    private com.shubham.weather.ui.DayWiseAdapter DayWiseAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DayWiseAdapter = new DayWiseAdapter(getApplicationContext());
        ...
        cursorAdapter = new SimpleCursorAdapter(this, R.layout.city_list_item, DayWiseAdapter.getAllCities(), DayWiseAdapter.getColumns(), to, 0);
        listView.setAdapter(cursorAdapter);

        listView.setOnItemClickListener((adapterView, view, i, l) -> {
            Cursor cursor = (Cursor) listView.getItemAtPosition(i);
            Map<String, String> cityCoords = DayWiseAdapter.getCityCoords(cursor);
            String cityID = DayWiseAdapter.getCityId(cursor);
            ...
            if(cityID == null) {
                ...
                DayWiseAdapter.close();
            }
        });

        forecastButton.setOnClickListener(view -> {
            Intent myIntent = new Intent(getBaseContext(), ForecastActivity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        search.setOnSearchClickListener(view -> setListViewVisible());
        ...
        cursorAdapter.setFilterQueryProvider(charSequence -> DayWiseAdapter.filterByName(charSequence.toString()));
